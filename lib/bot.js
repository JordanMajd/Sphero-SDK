 ...
 *
 * @param {String} model the model of robot to connect to.
 * @param {String} connection the type of connection used establish communication with the robot.
 * @param {String} controller the type of controller to attach to the robot.
...
var Bot = function(model, connection, controller){
  ...
  this.commands = require(model)(connection);
  if(controller){
...
Bot.registerModelType = function(modelName, modelPath){
...
Bot.registerConnectionType = function(connectionName, connectionPath){
...
Bot.registerControllerType = function(controllerName, controllerPath){
