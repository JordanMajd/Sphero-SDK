  ...
  this.startScan(
    function(peripheral){
      if(peripheral.uuid === uuid){
        ...
        this.peripheral.on('connect', this.discoverServicesAndCharacteristics.bind(this, callback));
...
NobleConnection.prototype.discoverServicesAndCharacteristics = function(callback){
  ...
  this.peripheral.discoverAllServicesAndCharacteristics(function(error, services, characteristics){
    ...
    var self = this;
    services.forEach(function(service){
      self.servicesMap[service.uuid] = service;
      service.characteristics.forEach(function(characteristic){
        self.servicesMap[service.uuid][characteristic.uuid] = characteristic;
      });
    });
...
NobleConnection.prototype.writeCharectaristic = function(serviceId, characteristicId, value, callback){
  var characteristic = this.servicesMap[serviceId][characteristicId];
