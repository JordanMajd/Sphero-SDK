...
SpheroCommand.prototype.setCalibration = function(heading){
  ...
  let packet = new CommandPacket(API.DID_SPHERO, API.CMD_SET_CAL, data).packetBuffer;
...
SpheroCommand.prototype.setStabilize = function(value){
  ...
  let packet = new CommandPacket(API.DID_SPHERO, API.CMD_SET_STABILIZ, data).packetBuffer;
  return this.create(CONTROL_SERVICE.id, CONTROL_SERVICE.commandsCharacteristic, packet);
};
...
SpheroCommand.prototype.setBackLED = function(intensity){
  ...
  let packet = new CommandPacket(API.DID_SPHERO, API.CMD_SET_BACK_LED, data).packetBuffer;
  return this.create(CONTROL_SERVICE.id, CONTROL_SERVICE.commandsCharacteristic, packet);
};
...
SpheroCommand.prototype.roll = function(speed, direction, state){
  ...
  let packet = new CommandPacket(API.DID_SPHERO, API.CMD_ROLL, data).packetBuffer;
